...
'use client'
import { Boarding } from '@/@types/ddmx'
...
type BoardingFormData = z.infer<typeof boardingFormSchema>

export function TabBoarding() {
  const routeForm = useForm<BoardingFormData>({
  ...
  const [data, setData] = useState<Boarding[] | undefined>()
